import sys
sys.path.append('/home/funsat/.local/lib/python3.9/site-packages')
import csv
import datetime
import time
import pytz
...
def main():
    ...
    filename = '/home/funsat/Desktop/FanSat2022.10.26/testdata'
    for i in range(100):
...
#制御開始
    ...
    while True:
        ...
        with open(filename_str,'a',newline="") as f:
            writer = csv.writer(f)
            writer.writerow(['control',gps.gps.timestamp[0],gps.gps.timestamp[1],gps.gps.timestamp[2],'latitude',gps.gps.latitude[0],'longitude',gps.gps.longitude[0],'acc',acc[0],acc[1],acc[2],let,'dir',dir_x,dir_y])
